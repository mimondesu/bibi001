         ...
         <div class="container-fluid">
            <nav class="navbar navbar-light bg-light justify-content-between">
               <div id="mySidenav" class="sidenav">
                  ...
                  <a href="../home1/product.type.html">Product Type</a>
                  <a href="../home1/login.html">Behind</a>
               ...
               <form class="form-inline ">
                  <div class="login_text">
                     <ul>
                        <li><a href="../home1/membership.html"><img src="images/user-icon.png"></a></li>
            ...
            <div class="carousel-inner">
               <div class="carousel-item active">
                  <div class="container">
                     <div class="row">
                        <div class="col-sm-6">
                           <h1 class="banner_taital">Bibi Glow <br></h1>
               ...
               <div class="row">
                  ...
                  <div class="col-lg-4 col-sm-6">
                     <div class="product_box">
                        <h4 class="bursh_text"><?php echo $data['p_name']."<br>"; ?></h4>
                        <p class="lorem_text"><?php echo $data['p_detail']."<br>"; ?> </p>
                        <img src="../im/<?php echo $data['p_id']; ?>.<?php echo $data['p_ext']; ?>">
                        <div class="btn_main">
                           <div class="buy_bt">
                              <ul>
                                 <li class="active"><a href="#">Buy Now</a></li>
                                 <li><a href="../home1/productdt1.php">รายละเอียด</a></li>
                              </ul>
                           </div>
                           <h3 class="price_text"><?php echo $data['p_price'] ; ?>  บาท</h3>
                        </div>
                     </div>
                  </div>
